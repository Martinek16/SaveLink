...
1. Install the extension in your browser (works with both Chrome and Firefox).
2. Click on the extension icon to open the popup.
3. Enter the URL and custom title of the web page you want to save.
4. Click the "Save Page" button to store the page in your local storage.
5. To view all the saved links, click the "Open Saved Links" button.
6. The saved links will be displayed in a new page with their favicons and custom titles.
...
Contributions are welcome! If you find any issues or have ideas for improvement, please feel free to submit an issue or a pull request.
